...
export function getCatConstants() {
  ...
  const requiredEnvVars: Record<string, string | undefined> = {
    NEXT_PUBLIC_ORACLE_SETUP_TX_HASH: process.env.NEXT_PUBLIC_ORACLE_SETUP_TX_HASH,
    NEXT_PUBLIC_COUNTER_SETUP_TX_HASH: process.env.NEXT_PUBLIC_COUNTER_SETUP_TX_HASH,
    NEXT_PUBLIC_MEMBERSHIP_INTENT_MINT_TX_HASH: process.env.NEXT_PUBLIC_MEMBERSHIP_INTENT_MINT_TX_HASH,
    NEXT_PUBLIC_MEMBERSHIP_INTENT_SPEND_TX_HASH: process.env.NEXT_PUBLIC_MEMBERSHIP_INTENT_SPEND_TX_HASH,
    NEXT_PUBLIC_MEMBER_MINT_TX_HASH: process.env.NEXT_PUBLIC_MEMBER_MINT_TX_HASH,
    NEXT_PUBLIC_MEMBER_SPEND_TX_HASH: process.env.NEXT_PUBLIC_MEMBER_SPEND_TX_HASH,
    NEXT_PUBLIC_PROPOSE_INTENT_MINT_TX_HASH: process.env.NEXT_PUBLIC_PROPOSE_INTENT_MINT_TX_HASH,
    NEXT_PUBLIC_PROPOSE_INTENT_SPEND_TX_HASH: process.env.NEXT_PUBLIC_PROPOSE_INTENT_SPEND_TX_HASH,
    NEXT_PUBLIC_PROPOSAL_MINT_TX_HASH: process.env.NEXT_PUBLIC_PROPOSAL_MINT_TX_HASH,
    NEXT_PUBLIC_PROPOSAL_SPEND_TX_HASH: process.env.NEXT_PUBLIC_PROPOSAL_SPEND_TX_HASH,
    NEXT_PUBLIC_SIGN_OFF_APPROVAL_MINT_TX_HASH: process.env.NEXT_PUBLIC_SIGN_OFF_APPROVAL_MINT_TX_HASH,
    NEXT_PUBLIC_SIGN_OFF_APPROVAL_SPEND_TX_HASH: process.env.NEXT_PUBLIC_SIGN_OFF_APPROVAL_SPEND_TX_HASH,
    NEXT_PUBLIC_TREASURY_SPEND_TX_HASH: process.env.NEXT_PUBLIC_TREASURY_SPEND_TX_HASH,
    NEXT_PUBLIC_TREASURY_WITHDRAWAL_TX_HASH: process.env.NEXT_PUBLIC_TREASURY_WITHDRAWAL_TX_HASH,
  };
